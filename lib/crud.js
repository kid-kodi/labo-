...
var
  ...
  dbHandle    = new mongodb.Db(
    'labo', mongoServer, { safe : true }
  ),
  validator   = JSV.createEnvironment(),

  objTypeMap  = { 
    'user'        : {}, 'unite'         : {}, 'customer' : {}, 'sample_type' : {},
    'client'       : {}, 'message'      : {}, 
    'type_client'      : {}, 'prestation'     : {}, 
    'societe'       : {}, 'contrat'          : {},
    'medecin_service'  : {}, 'medecin_etablissement' : {},
    'mode_paiement'        : {}, 'counter'           : {},
    'order' : {}, 'facture' : {},
    'salle'       : {}, 'typerack'       : {},
    'typeboite'   : {}, 'analyse'        : {},
    'equipement_place' : {}, 'rack_place' : {},
    'boite_place'      : {}, 'emplacement'   : {},
    'patient'          : {}, 'jour' : {}, 'mois' : {}, 'annee' : {},
    'etablissement' : {}, 'medecin' : {}, 'diagnostic' : {} , 
    'reception' : {}, 'prelevement' : {}, 'counter' : {}, 
    'conformite' : {}, 'type_conformite' : {}, 'pays' : {}, 
    'ville' : {}, 'commune' : {}, 'type_piece' : {}, 'entry' : {}, 'method' : {}, 'interpretation' : {}
  };
...
readObj = function ( obj_type, find_map, fields_map, callback ) {
  ...
  //cache.getValue( find_map, callback, function () {
    dbHandle.collection(
      obj_type,
      function ( outer_error, collection ) {
        collection.find( find_map, fields_map ).sort({_id:-1}).toArray(
...
(function () {
  ...
  for ( schema_name in objTypeMap ) {
    if ( objTypeMap.hasOwnProperty( schema_name ) ) {
      schema_path = __dirname + '/schemas/' + schema_name + '.json';
