...
angular.module('ngCart.directives', ['ngCart.fulfilment'])
    ...
    .directive('ngcartBtncart', ['ngCart', function(ngCart){
        return {
            restrict : 'E',
            ...
            templateUrl: function(element, attrs) {
                if ( typeof attrs.templateUrl == 'undefined' ) {
                    return 'template/ngCart/btncart.html';
                } else {
    ...
    .directive('tocart', ['ngCart', function(ngCart){
        return {
            restrict : 'E',
            controller : 'CartController',
            scope: {
            ...
            templateUrl: function(element, attrs) {
                if ( typeof attrs.templateUrl == 'undefined' ) {
                    return 'template/ngCart/checkitem.html';
                } else {
                    return attrs.templateUrl;
                }
            },
